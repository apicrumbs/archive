...
/**
 * SicTranslatorCrumb - The "Static Map".
 * Purpose: Local lookup for UK SIC codes to save API latency and LLM tokens.
 */
class CompaniesHouseSicCrumb extends BaseCrumb 
{
    /**
     * A snippet of the UK SIC 2007 dataset.     
     */
    private array $sicMap = [
    ...
    public function getName(): string { return 'business/companieshousesic'; }
    public function getVersion(): string { return '1.0.0'; }
    public function getDependencies(): array { return ['']; }

    /**
     * No API call needed. We just look up the ID in our local map.
     */
    public function fetchData(string $id, array $context = []): array 
    {
        return [
            'code' => $id,
            'description' => $this->sicMap[$id] ?? 'Unknown Classification'
        ];
    }

    /**
     * Refined Markdown for the LLM.
     */
    public function transform(array $data): string 
    {
        return <<<EOD
### {$this->getName()}: {$data['code']}
<!-- Source: Gov UK | Refined by: ApiCrumbs -->        
- **Industry**: {$data['description']}
> Info: UK SIC description is matched to the provided SIC code.
